...
class TestFixedPrec(unittest.TestCase):
  ...
  def test_div_mod(self):
    self.assertEquals(FixedPrec('-21.0') // FixedPrec('10.0'), -3)
    self.assertEquals(FixedPrec('-11.0') // FixedPrec('10.0'), -2)
    self.assertEquals(FixedPrec('-10.0') // FixedPrec('10.0'), -1)
    self.assertEquals(FixedPrec('-9.0') // FixedPrec('10.0'), -1)
    self.assertEquals(FixedPrec('-1.0') // FixedPrec('10.0'), -1)
    self.assertEquals(FixedPrec('0.0') // FixedPrec('10.0'), 0)
    self.assertEquals(FixedPrec('9.0') // FixedPrec('10.0'), 0)
    self.assertEquals(FixedPrec('10.0') // FixedPrec('10.0'), 1)
    self.assertEquals(FixedPrec('12.0') // FixedPrec('10.0'), 1)
    self.assertEquals(FixedPrec('20.0') // FixedPrec('10.0'), 2)
    self.assertEquals(FixedPrec('22.0') // FixedPrec('10.0'), 2)
    
    self.assertEquals(FixedPrec('-21.0') % FixedPrec('10.0'), FixedPrec('9.0'))
    self.assertEquals(FixedPrec('-11.0') % FixedPrec('10.0'), FixedPrec('9.0'))
    self.assertEquals(FixedPrec('-10.0') % FixedPrec('10.0'), FixedPrec('0.0'))
    self.assertEquals(FixedPrec('-9.0') % FixedPrec('10.0'), FixedPrec('1.0'))
    self.assertEquals(FixedPrec('-1.0') % FixedPrec('10.0'), FixedPrec('9.0'))
    self.assertEquals(FixedPrec('0.0') % FixedPrec('10.0'), FixedPrec('0.0'))
    self.assertEquals(FixedPrec('9.0') % FixedPrec('10.0'), FixedPrec('9.0'))
    self.assertEquals(FixedPrec('10.0') % FixedPrec('10.0'), FixedPrec('0.0'))
    self.assertEquals(FixedPrec('12.0') % FixedPrec('10.0'), FixedPrec('2.0'))
    self.assertEquals(FixedPrec('20.0') % FixedPrec('10.0'), FixedPrec('0.0'))
    self.assertEquals(FixedPrec('22.0') % FixedPrec('10.0'), FixedPrec('2.0'))
    
    
    self.assertEquals(divmod(FixedPrec('-21.0'), FixedPrec('10.0')), (-3, FixedPrec('9.0')))
    self.assertEquals(divmod(FixedPrec('-11.0'), FixedPrec('10.0')), (-2, FixedPrec('9.0')))
    self.assertEquals(divmod(FixedPrec('-10.0'), FixedPrec('10.0')), (-1, FixedPrec('0.0')))
    self.assertEquals(divmod(FixedPrec('-9.0'), FixedPrec('10.0')), (-1, FixedPrec('1.0')))
    self.assertEquals(divmod(FixedPrec('-1.0'), FixedPrec('10.0')), (-1, FixedPrec('9.0')))
    self.assertEquals(divmod(FixedPrec('0.0'), FixedPrec('10.0')), (0, FixedPrec('0.0')))
    self.assertEquals(divmod(FixedPrec('9.0'), FixedPrec('10.0')), (0, FixedPrec('9.0')))
    self.assertEquals(divmod(FixedPrec('10.0'), FixedPrec('10.0')), (1, FixedPrec('0.0')))
    self.assertEquals(divmod(FixedPrec('12.0'), FixedPrec('10.0')), (1, FixedPrec('2.0')))
    self.assertEquals(divmod(FixedPrec('20.0'), FixedPrec('10.0')), (2, FixedPrec('0.0')))
    self.assertEquals(divmod(FixedPrec('22.0'), FixedPrec('10.0')), (2, FixedPrec('2.0')))
