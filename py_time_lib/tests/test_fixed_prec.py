...
class TestFixedPrec(unittest.TestCase):
  ...
  def test_from_basic(self):
    ...
    self.assertEqual(FixedPrec.from_basic(0.0).to_hashable_tuple(), FixedPrec(0, 15).to_hashable_tuple())
    self.assertEqual(FixedPrec.from_basic(-3.0).to_hashable_tuple(), FixedPrec(-3_000_000_000_000_000, 15).to_hashable_tuple())
  ...
  def test_hash(self):
    ...
    self.assertEqual(hash(FixedPrec('17846517823657823658916666263.5')), hash(('FixedPrec', 178465178236578236589166662635, 1, 12)))
